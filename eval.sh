...
save_name=bigdata_1k6h_cldnn_${left_context}_${right_context}_${lr}_${sample_rate}_${kernel_size}_${kernel_num}/
exp_dir=exp/${save_name} #ldnn_${left_context}_${right_context}_${lr}_${sample_rate}_${kernel_size}_${kernel_num}/
exp_dir=exp/sruc_1_1_0.0005_16k_6_9_400_200/

for snr in -5  0  5  10  15  20 ; do
    clean_wav_path=/home/work_nfs2/yxhu/tools/py_add_noise/testset_2019/out_clean_${snr}/
    noisy_wav_path=/home/work_nfs2/yxhu/tools/py_add_noise/testset_2019/out_noisy_${snr}/
    enh_wav_path=${exp_dir}/noisy_${snr}/
    tgt=sruc_short_2w_${snr}db
    find ${noisy_wav_path} -iname "*.wav" > wav.lst
/home/work_nfs/common/tools/pyqueue_asr.pl \
    -l hostname='!node9' \
    -q g.q --gpu 1 --num-threads ${num_gpu} \
    ${exp_dir}/test_set.log \
    python -u ./steps/run_sruc.py \
    --decode=1 \
    --fft-len=${fft_len} \
    --input-dim=${input_dim} \
    ...
    mv ${exp_dir}/rec_wav ${exp_dir}/noisy_${snr}

    ls $noisy_wav_path > t
    python ./tools/run_pesq.py --wav_list=t --result_list=${tgt}.csv --pathe=${enh_wav_path}\
