...
static auto registry_1 = 
torch::jit::RegisterOperators("sru::cpu_forward", &cpu_forward);
static auto registry_2 = 
torch::jit::RegisterOperators("sru::cpu_bi_forward", &cpu_bi_forward);
